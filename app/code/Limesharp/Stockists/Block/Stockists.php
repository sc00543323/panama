...
class Stockists extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return $this->_scopeConfig->getValue('general/store_information/street_line1').', '.$this->_scopeConfig->getValue('general/store_information/street_line2').' ,'.$this->_scopeConfig->getValue('general/store_information/city').' ,'.$this->_scopeConfig->getValue('general/store_information/country_id');
    }
